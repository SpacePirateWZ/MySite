...
(function($, window, document, undefined){
    ...
    $(function(){
        ...
        $('.mendo-install-now').on( 'click', function( event ) {
            ...
            function buttonStatusInProgress( message ){
                $button.addClass('updating-message').removeClass('button-disabled mendo-pi-not-installed installed').text( message );
            }
            ...
            function buttonStatusDisabled( message ){
                $button.removeClass('updating-message mendo-pi-not-installed installed')
            ...
            function buttonStatusInstalled( message ){
                $button.removeClass('updating-message mendo-pi-not-installed')
                        .addClass('installed')
                        .text( message );
            }
